...
public enum SquaresEnum {
    ...
    public static List<SquaresEnum> emptySquares = new ArrayList<SquaresEnum>(Arrays.asList(SquaresEnum.values()));
    public static List<SquaresEnum> occupiedSquares = new ArrayList<SquaresEnum>();
    public static void FromEmptyToOccupied(SquaresEnum from, SquaresEnum to){
        emptySquares.remove(from);
        occupiedSquares.add(to);
    }
    public static void ToOccupied(SquaresEnum from){
        emptySquares.remove(from);
        occupiedSquares.add(from);
    }
    public static void FromOccupiedToEmpty(SquaresEnum from, SquaresEnum to){
        occupiedSquares.remove(from);
        emptySquares.add(to);
    }
    public static void ToEmpty(SquaresEnum to){
        occupiedSquares.remove(to);
        emptySquares.add(to);
    }

    SquaresEnum(int x, int y, String color){
        this.coordX = x;
        this.coordY = y;
        this.color = color;
    }
