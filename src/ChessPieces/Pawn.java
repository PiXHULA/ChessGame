...
public class Pawn extends Piece {
    ...
    public void moveFromLocation(Graphics g, Squares from){
        g.clearRect(from.getCoordX() + 19,from.getCoordY() + 19, SquareSize.SQUARESIZE.getSize() / 2,
                SquareSize.SQUARESIZE.getSize() / 2);

        g.clearRect(from.getCoordX() + 10,from.getCoordY() + 10, SquareSize.SQUARESIZE.getSize() - 20,
                SquareSize.SQUARESIZE.getSize() - 20);
